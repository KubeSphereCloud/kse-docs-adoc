...
* **未提交**：应用版本已上传到企业空间，但未提交给 KubeSphere 平台的应用商店管理员审核。

* **已提交**：应用版本已提交给 KubeSphere 平台的应用商店管理员审核。

* **已发布**：应用版本已获得 KubeSphere 平台的应用商店管理员的批准，可以上架到应用商店。

* **已拒绝**：应用版本未获得 KubeSphere 平台的应用商店管理员的批准，审核不通过。

* **未发布**：应用版本发布后被应用商店管理员取消发布，或应用版本上架到 KubeSphere 平台的应用商店后被应用商店管理员下架。
