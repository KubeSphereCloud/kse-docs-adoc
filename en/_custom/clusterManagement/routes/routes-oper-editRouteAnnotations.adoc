...
. On the right side of the Ingress you want to operate, click image:/images/ks-qkcp/zh/icons/more.svg[more,18,18], then select **Edit Annotations** from the dropdown list.
