...
keywords: "Kubernetes, {ks_product}, Project Management, Application Workloads, Workload, Create a Workload"
...
Refer to link:#_parameter-description[Parameter Description] to set the parameters for the workload.
...
The following describes how to set the parameters for a workload.
