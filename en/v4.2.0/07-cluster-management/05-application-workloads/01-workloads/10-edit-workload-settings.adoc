...
keywords: "Kubernetes, {ks_product}, Cluster Management, Application Workloads, Workload, Edit Workload Settings"
description: "Describes how to edit the settings of a created workload."
weight: 10
---
...
. In the **Edit Settings** dialog box, set the workload's update policy, containers, storage, pod scheduling rules (not available for DaemonSets), and pod graceful termination respectively, then click **OK**. For specific parameter configuration methods, please refer to link:#_parameter-description[Parameter Description].
