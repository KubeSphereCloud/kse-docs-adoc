...
description: "Introduces the KubeSphere LuBan architecture and extensions."
weight: 02
---
...
image:/images/ks-qkcp/en/v4.0/4.0-architecture.png[architecture,80%]
...
Visit link:https://kubesphere.com.cn/extensions/marketplace/[KubeSphere Marketplace] to view and install published extensions.
...
. Inject new menus and functional pages into the project's left navigation pane, supporting the management of more types of resources.
. Inject functional entry points into the platform-level menu to enhance platform management capabilities.
. Directly embed existing third-party functional component pages into KubeSphere to aggregate disparate systems.
. Override existing page routes in KubeSphere to implement your unique business logic.
. Extend KubeSphere's APIs.

If you want a more comprehensive understanding of the extension API, please refer to link:https://dev-guide.kubesphere.io/extension-dev-guide/en/feature-customization/[Extension Capabilities].

== How to Build an Extension?

Please refer to the link:https://dev-guide.kubesphere.io/extension-dev-guide/en/best-practice/develop-example/[Development Examples] chapter to familiarize yourself with how to build an extension.

If you have questions during the development of an extension, please try to get help via link:https://github.com/kubesphere/kubesphere/issues/new/choose[GitHub Issue].

== How to Publish an Extension?

Please refer to link:https://dev-guide.kubesphere.io/extension-dev-guide/en/packaging-and-release/release/[Publishing Extensions] to learn how to submit an extension to the KubeSphere Marketplace.