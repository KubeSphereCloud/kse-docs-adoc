...
若要联邦项目运行在多个集群上，联邦项目所属的企业空间必须获得多个集群的授权。有关更多信息，请参阅《KubeSphere 企业空间和项目管理指南》的“创建企业空间”章节。
endif::[]
|===
...
|集群
|可供项目使用的集群。项目中的资源运行在此处选择的集群中。创建联邦项目时，可点击**添加**选择多个集群从而使项目中的资源运行在不同的集群中。
|===
