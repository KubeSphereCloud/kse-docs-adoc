...
. On the **Resource Status** tab, view the pods that have mounted the PersistentVolume corresponding to the PersistentVolumeClaim.
+
--
[%header,cols="1a,4a"]
|===
...
|Mounted Pods
|
Displays the pods that have mounted the PersistentVolume corresponding to the PersistentVolumeClaim.

include::../nodes/nodes-para-podList.adoc[]
|===
--

. Click the **Metadata** tab to view the labels and annotations of the PersistentVolumeClaim.

. Click the **Events** tab to view the events of the PersistentVolumeClaim.
+
--
