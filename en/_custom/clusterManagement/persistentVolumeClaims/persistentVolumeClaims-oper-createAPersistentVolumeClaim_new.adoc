...
|PersistentVolume
|Select an existing PersistentVolume to create the PersistentVolumeClaim.
|===
--
...
After creation, the PersistentVolumeClaim will appear in the PersistentVolumeClaim list.
--