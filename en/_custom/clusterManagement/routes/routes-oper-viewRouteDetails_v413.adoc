...
|Domain and Port
|The domain name and node port number of the Ingress. The node port number is displayed only when the external access mode of the cluster gateway or project gateway is NodePort.
