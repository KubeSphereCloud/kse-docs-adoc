...
. 在容器组详情页面点击**调度信息**页签查看容器组的调度结果和状态信息。
+
--
[%header,cols="1a,4a"]
|===
...
. 在容器组详情页面点击**元数据**页签查看容器组的标签和注解。

. 在容器组详情页面点击**监控**页签查看容器组的实时资源使用情况。
+
--
[%header,cols="1a,4a"]
|===
...
. 在容器组详情页面点击**环境变量**页签查看容器组中的所有容器的环境变量。

. 在容器组详情页面点击**事件**页签查看容器组相关的事件。
+
--
