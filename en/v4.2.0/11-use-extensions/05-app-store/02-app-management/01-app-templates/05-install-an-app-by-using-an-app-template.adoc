...
. 在应用模板详情页面的**版本**页签，点击所需的应用版本，然后在展开的区域中点击**部署**。
...
KubeSphere 的应用模板功能底层基于 Helm Chart 实现。**应用设置**页签的参数设置应符合 Helm Chart 的 Values 文件规范。有关更多信息，请参阅 link:https://helm.sh/zh/docs/chart_template_guide/values_files/[Helm 官方文档]。
...
应用安装完成后，即可在目标项目中查看已安装的应用。有关更多信息，请参阅《KubeSphere 企业空间和项目管理指南》的“应用”章节。
endif::[]
--
