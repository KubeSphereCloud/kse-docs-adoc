...
* 点击**物理资源**和**应用资源用量**中的折线图，查看资源用量随时间变化的详细信息。选择一个项目，点击确定，查看特定项目的资源用量信息。
--

. 点击**用量排行**，查看企业空间中的项目的资源使用情况。
+
--
...
. 点击**集群信息**，查看授权给企业空间的集群的 CPU、内存、磁盘的总量和已使用量，以及集群上可创建容器组的总数和已创建容器组的数量。
+
--
// Note
