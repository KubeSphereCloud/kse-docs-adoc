---
title: "Setting up Email Server for Pipelines"
keywords: "Kubernetes, {ks_product}, DevOps project, Using DevOps, pipeline"
description: "This section introduces how to set up an email server for pipelines."
weight: 11
---
...
. In the left navigation pane, select **Workloads** under **Application Workloads**, and choose **kubesphere-devops-system** from the drop-down list. Click the image:/images/ks-qkcp/zh/icons/more.svg[more,18,18] icon on the right side of **devops-jenkins** and select **Edit YAML**.
