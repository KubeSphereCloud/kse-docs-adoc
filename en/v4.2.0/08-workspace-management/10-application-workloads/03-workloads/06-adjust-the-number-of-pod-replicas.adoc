...
keywords: "Kubernetes, {ks_product}, Project Management, Application Workloads, Workloads, Adjust the Number of Pod Replicas"
description: "This document describes how to adjust the number of pod replicas."
weight: 06
---
